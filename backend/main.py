...
from services import faiss_service, document_service
...
app = FastAPI(
    ...
    description="A system to process documents and answer questions using AI.",
    version="1.0.0"
)
...
async def run_submission(
    ...
    if doc_hash in document_cache:
        ...
        try:
            ...
            faiss_service.add_texts(chunks)
    ...
    for question in request.questions:
        try:
            relevant_chunks = faiss_service.search(question, k=5)
